    ...
    <div className=" -ml-2 -mr-3 w-52  max-lg:max-w-[50vw] lg:w-60 ">
      <div className=" relative group">
        ...
        <img
          onClick={() =>
            navigate(
              loc.pathname + "?" + param.toString() + "&image=" + fileUrl
            )
          }
        ...
        <a
          href={fileUrl}
          className=" absolute bottom-0 right-0  p-2  hidden border-2 cursor-pointer rounded-full group-hover:rounded-none group-hover:rounded-tl-full   group-hover:block bg-gray-900 text-white pl-4 pt-4"
        >
    ...
    <a className=" " href={fileUrl} target="_blank">
      <div className="hover:bg-gray-200 group cursor-pointer -ml-2 -mr-3 w-52  max-lg:max-w-[50vw] lg:w-60  flex items-end p-2 rounded-lg bg-white  gap-1">
        <div className=" flex flex-col gap-1">
          ...
          <p className=" text-sm font-bold text-left text uppercase">
            {getFileType(fileUrl)}
          </p>
        </div>
